...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BL] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, KC_APP,  KC_RCTL, TO(ML),   MO(ML)
    ),
    ...
    [ML] = LAYOUT(
        ...
        MO(FL),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_DEL,
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPC,  KC_SPC,  KC_SPC,           KC_RALT, KC_APP,  KC_RCTL, TO(BL),   KC_RCTL
    ),
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  default:
    // Default colors - teal
    rgblight_sethsv_noeeprom(140, 255, BRIGHTNESS);
    break;
  }
  return state;
}